...
public abstract class ClientLevelMixin extends Level implements IClientLevel {
	...
	private ClientLevelMixin(LevelData data, DimensionType dimension, BiFunction<Level, Dimension, ChunkSource> chunkSource, ProfilerFiller profiler, boolean isClient) {
